# Qishui/QQ Music 플레이리스트를 Apple/Youtube/Spotify Music으로 이전하기

> [简体中文](README.md)  | [English](README_EN.md) | 한국어

링크: [https://music.unmeta.cn](https://music.unmeta.cn)

이 프로젝트의 백엔드는 Golang + Hertz를 사용하여 개발되었고, 프론트엔드는 Vue + ElementUI로 구축되었습니다.

<img src="misc/images/0.png" style="width:60%; border: 1px solid black;" />

# 사용 안내

1. 플레이리스트 링크 입력, 예: https://y.qq.com/n/ryqq/playlist/7364061065
2. 검색 결과 복사
